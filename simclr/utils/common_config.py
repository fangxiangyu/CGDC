...
def get_train_dataset(p, transform, to_augmented_dataset=False,
                        to_neighbors_dataset=False, train=None):
    # Base dataset
    if p['train_db_name'] == 'cifar-10':
        from data.cifar import CIFAR10
        dataset = CIFAR10(train=train, transform=transform, download=True)
        ...
        dataset = CIFAR20(train=train, transform=transform, download=True)
